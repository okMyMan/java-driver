    ...
    private static class Builder {
        ...
        private void validateOrder(int unitIndex) {
            if (unitIndex == currentUnitIndex)
                throw new InvalidTypeException(String.format("Invalid duration. The %s are specified multiple times", getUnitName(unitIndex)));

            if (unitIndex <= currentUnitIndex)
                throw new InvalidTypeException(String.format("Invalid duration. The %s should be after %s",
